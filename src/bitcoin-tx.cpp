...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " roundcoin-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  roundcoin-tx [options] <hex-tx> [commands]  Update hex-encoded roundcoin transaction\n" +
            "or:     roundcoin-tx [options] -create [commands]   Create hex-encoded roundcoin transaction\n" +
            "\n";
