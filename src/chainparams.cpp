...
{
    const char* pszTimestamp = "4/20/2020 Provigen Networks: Now accepting reverseroshies!";
...
public:
    CMainParams() {
        ...
        consensus.BIP34Hash = uint256S("141e82d13ef633377d62359c58963a40241589109dc2b44185a62f20943d0956");
        ...
        consensus.defaultAssumeValid = uint256S("0x141e82d13ef633377d62359c58963a40241589109dc2b44185a62f20943d0956"); //1683528
        ...
        genesis = CreateGenesisBlock(1585899859, 1200656, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0x141e82d13ef633377d62359c58963a40241589109dc2b44185a62f20943d0956"));
        assert(genesis.hashMerkleRoot == uint256S("0xeb7b37d847c2b00da55f27d46e383bd0eb870d8b3199e0a62cad0c4b890de500"));
...
public:
    CTestNetParams() {
        ...
        genesis = CreateGenesisBlock(1486949366, 817915, 0x1e0ffff0, 1, 50 * COIN);
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xa0c2f926611894df9e543b1905328fa4e058c7ad162c14def689a22da620d509"));
        assert(genesis.hashMerkleRoot == uint256S("0xeb7b37d847c2b00da55f27d46e383bd0eb870d8b3199e0a62cad0c4b890de500"));

        vFixedSeeds.clear();
        vSeeds.clear();
        // nodes with support for servicebits filtering should be at the top
        vSeeds.emplace_back("testnet-seed.roundcointools.com");
        vSeeds.emplace_back("seed-b.roundcoin.loshan.co.uk");
...
public:
    explicit CRegTestParams(const ArgsManager& args) {
        ...
        consensus.hashGenesisBlock = genesis.GetHash();
        assert(consensus.hashGenesisBlock == uint256S("0xfc7783fa3933beed0174bbc5b3142925a6a0939b1704d72e2d730ef2efb42c4b"));
        assert(genesis.hashMerkleRoot == uint256S("0xeb7b37d847c2b00da55f27d46e383bd0eb870d8b3199e0a62cad0c4b890de500"));
