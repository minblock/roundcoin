# Support for Output Descriptors in Roundcoin Core

Since Roundcoin Core v0.17, there is support for Output Descriptors. This is a
...
on Roundcoin's OP_CHECKMULTISIG opcode. To support these, we introduce the
...
existing Roundcoin Core wallets, a convenience function `combo` is
