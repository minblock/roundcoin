...
"""Verify that starting roundcoin with -h works as expected."""
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start roundcoin with -h for help text")
        ...
        self.log.info("Start roundcoin with -version for version information")
        ...
        self.log.info("Start roundcoind with -fakearg to make sure it does not start")
